    ...
    <>
        ...
        <div className="public-container editorial-two-column">
          ...
          <div>
            <h2 id="mission-heading">
              A student engineering team built for the full system.
            </h2>
            <p className="editorial-lede">
              KAALKRIT is the official drone and robotics innovation team of Sir
              M. Visvesvaraya Institute of Technology, Bengaluru. Established in
              2024, the team connects research, engineering, and practical
              learning around autonomous systems.
            </p>
          </div>
        </div>
      </section>
      ...
      >
        <div className="public-container">
          ...
          <div className="reasons-grid">
            <article>
              <span>01</span>
              <h3>Full-lifecycle engineering</h3>
              <p>
                From research and system architecture to manufacturing, testing,
                validation, and iteration, the work is considered as one
                connected lifecycle.
              </p>
            </article>
            <article>
              ...
              <p>
                Hardware, software, robotics, embedded systems, AI, and computer
                vision meet through a shared engineering practice.
              </p>
            </article>
            <article>
              <span>03</span>
              <h3>One system, many disciplines</h3>
              <p>
                Mechanical design, electronics integration, sensor integration,
                control, and software development are brought together with
                real-world intent.
              </p>
            </article>
          </div>
        ...
        <div className="public-container">
          <div className="editorial-section__heading">
            ...
            <h2 id="lifecycle-heading">
              From a question to a validated system.
            </h2>
          </div>
          ...
          <div className="editorial-two-column">
            ...
            <div>
              <h2 id="capabilities-heading">
                Capability lives in the connections.
              </h2>
              <p className="editorial-lede">
                The index is deliberately broad: each discipline becomes more
                useful when it is designed alongside the others.
              </p>
            </div>
          </div>
      ...
      >
        <div className="public-container">
          <div className="editorial-two-column projects-heading">
            ...
            <div>
              <h2 id="projects-heading">
                Work that makes the ambition tangible.
              </h2>
              <p className="editorial-lede">
                Each project record keeps its documented scope, status, and
                engineering focus in view.
              </p>
            </div>
          </div>
          ...
          <Link href="/projects" className="text-link">
            View the documented project index <span aria-hidden="true">→</span>
          </Link>
        </div>
      </section>
      ...
      >
        <div className="public-container culture-grid">
          <div className="culture-grid__media" aria-hidden="true">
            <div className="culture-grid__image culture-grid__image--empty">
              <span>KAALKRIT / PRACTICE</span>
            </div>
          </div>
          <div>
            <p className="eyebrow">06 / Team and culture</p>
            <h2 id="culture-heading">
              A multidisciplinary team with room to learn by making.
            </h2>
            <p>
              KAALKRIT brings students together across engineering domains for
              research, documentation, collaborative work, and practical systems
              building. No roster is published until it can be represented
              accurately.
            </p>
            <TrackedLink
      ...
      >
        <div className="public-container editorial-two-column">
          ...
          <div>
            <h2 id="achievement-heading">Progress worth stating plainly.</h2>
      ...
      >
        <div className="public-container">
          ...
          <h2 id="future-heading">
            A direction for deeper, more connected systems.
          </h2>
          <p className="editorial-lede">
            KAALKRIT intends to keep exploring swarm intelligence,
            computer-vision-driven autonomy, advanced embedded platforms,
            robotic manipulators, and integrated autonomous ecosystems across
            sectors where engineering can be useful.
          </p>
          ...
          <BorderGlow>
            <div className="partnership-card">
              ...
              <h2 id="partnership-heading">
                Bring serious engineering conversations to the table.
              </h2>
              <p>
                KAALKRIT welcomes conversations with industry, startups,
                academia, research organisations, and engineering communities
                that want to engage meaningfully with student-led deep-tech
                work.
              </p>
              <TrackedLink
              ...
              >
                Partner with KAALKRIT <span aria-hidden="true">↗</span>
              </TrackedLink>
            </div>
          </BorderGlow>
        </div>
      ...
      >
        <div className="public-container join-section__content">
          <p className="eyebrow">10 / Recruitment</p>
          <h2 id="join-heading">Build the next system with KAALKRIT.</h2>
          <p>
            For students interested in multidisciplinary engineering, research,
            and practical systems work.
          </p>
          <TrackedLink
            href={mailto("Joining Team KAALKRIT")}
            className="button button--secondary"
          ...
          >
            Write to KAALKRIT <span aria-hidden="true">↗</span>
          </TrackedLink>
        </div>
      </section>
    </>
