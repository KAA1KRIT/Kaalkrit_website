 ...
 */
export function MetaLine({ items, className = '' }: { items: string[]; className?: string }) {
  return (
    <ul className={`k-meta flex flex-wrap items-center gap-x-[var(--k-3)] gap-y-[var(--k-1)] ${className}`}>
