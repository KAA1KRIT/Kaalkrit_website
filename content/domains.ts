...
export const domainGroups: DomainGroup[] = [
  { id: 'air', label: 'Air', note: 'Airframes, flight, and everything that keeps them in it.' },
  { id: 'machine', label: 'Machine', note: 'Structures that move, and the control that governs them.' },
  { id: 'silicon', label: 'Silicon & Software', note: 'Boards, firmware, perception, and the systems around them.' },
  { id: 'method', label: 'Method', note: 'How work becomes a product rather than a prototype.' },
];
...
export const domains: Domain[] = [
  ...
  { id: 'flight-control', label: 'Flight Control & Autonomous Navigation', group: 'air' },

  { id: 'robotics', label: 'Robotics & Automation', group: 'machine' },
  { id: 'mechanical', label: 'Mechanical Design & Rapid Prototyping', group: 'machine' },
  { id: 'sensors', label: 'Sensor Integration & Control Systems', group: 'machine' },

  { id: 'embedded', label: 'Embedded Systems Development', group: 'silicon' },
  { id: 'pcb', label: 'PCB Design & Electronics', group: 'silicon' },
  { id: 'ai-cv', label: 'Artificial Intelligence & Computer Vision', group: 'silicon' },
  { id: 'software', label: 'Software & Full-Stack Development', group: 'silicon' },
