...
export const collaborationModes: CollaborationMode[] = [
  ...
  },
  {
    ...
    description: 'Share engineering perspective around flight control, embedded systems, manufacturing or related disciplines.',
    subject: 'KAALKRIT — engineering mentorship',
  },
  {
    id: 'research',
    title: 'Research collaboration',
    description: 'Explore shared research questions in autonomy, computer vision, embedded systems or robotics.',
